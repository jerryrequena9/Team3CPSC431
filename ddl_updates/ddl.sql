...
GRANT SELECT                           ON football.Player       TO 'Coach'@'localhost';
...
GRANT SELECT, INSERT, UPDATE, DELETE   ON football.Game         TO 'Coach'@'localhost';
GRANT SELECT, INSERT, UPDATE, DELETE   ON football.Stat         TO 'Coach'@'localhost';
