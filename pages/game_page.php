<?php
  ...
  function display_edit_game() {
    ...
    // Fetch games
    $query = "
        SELECT g.game_id, g.week, g.date, g.home_score, g.away_score,
               g.home_team_id, g.away_team_id, g.season_id
        FROM Game g
        ORDER BY g.date, g.week ASC
    ";
